    ...
    return (
        <div className="flex flex-col items-center py-6 md:py-10 px-1 md:px-0 max-w-4xl mx-auto space-y-8 md:space-y-10">
            ...
            <div className="text-center space-y-3">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1e3a5f]/10 text-[#1e3a5f] font-black text-xs md:text-sm mb-2">
                ...
                <h4 className="text-[22px] md:text-4xl font-black text-gray-900 tracking-tighter break-keep leading-tight">
                    사장님 주목! 🙌<br />
                    웨이터존가<br className="md:hidden" /> <span className="text-[#1e3a5f]">통큰 혜택</span>을 쏩니다!
                </h4>
            </div>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-white border-2 border-gray-100 rounded-[30px] p-6 md:p-10 shadow-sm hover:shadow-md transition-shadow">
                    <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-[#1e3a5f] mb-4">
                        <CheckCircle2 size={24} />
                    </div>
                    <p className="text-[#1e3a5f] font-black text-[11px] uppercase tracking-widest mb-1">Benefit 01</p>
                ...
                <div className="bg-white border-2 border-gray-100 rounded-[30px] p-6 md:p-10 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-[#1e3a5f] font-black text-[11px] uppercase tracking-widest mb-1">Benefit 02</p>
            ...
            <div className="w-full bg-slate-50 border border-slate-100 rounded-[32px] p-6 md:p-8 space-y-4">
                ...
                <ul className="space-y-2.5">
                    <li className="flex items-start gap-2 text-[13px] md:text-sm font-bold text-gray-600 leading-relaxed break-keep">
                        <span className="text-[#1e3a5f] shrink-0 mt-1">※</span>
            ...
            <div className="w-full text-center space-y-6">
                ...
                <div className="w-full bg-[#1e3a5f] text-white p-5 md:p-6 rounded-[24px] shadow-lg shadow-sm animate-in fade-in zoom-in duration-500">
